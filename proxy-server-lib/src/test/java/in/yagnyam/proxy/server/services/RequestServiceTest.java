...
public class RequestServiceTest {
  ...
  public void testRequestExistsWithId_Exists() {
    when(requestRepository.getRequest(anyString()))
        .thenReturn(Optional.of(mock(RequestEntity.class)));
  ...
  public void testSaveRequestEntity_Invalid() {
    ...
    assertNullPointerExceptionThrown("Null Arguments",
        () -> requestService.saveRequestEntity(null, null));
  }
