...
public class RequestService {
   ...
   */
  public void assertNewRequest(@NonNull String requestId, String requestType)
   ...
   */
  public void saveRequestEntity(@NonNull String requestId, @NonNull String requestType)
      throws BadRequestException {
   ...
   * @throws BadRequestException if request is already processed
   */
  public <T extends SignableRequestMessage> void saveSignedRequestMessage(
      @NonNull SignedMessage<T> request) throws BadRequestException {
   ...
   */
  public void saveRequestEntity(@NonNull String requestId, @NonNull String requestType,
      String requestPayload) throws BadRequestException {
    RequestEntity requestEntity = RequestEntity.builder()
        .requestId(requestId)
