...
public class BcCertificateRequestService implements CertificateRequestService {
  ...
  @Override
  public String createCertificateRequest(String signatureAlgorithm, KeyPair keyPair,
    ...
    try {
      ...
      PKCS10CertificationRequest certificationRequest = new JcaPKCS10CertificationRequestBuilder(
