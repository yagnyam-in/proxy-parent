...
public class MessageSerializerService {
    ...
    public <T extends SignableMessage> String serializeSignedMessage(SignedMessage<T> message) throws IOException {
        try {
    ...
    public <T extends SignableMessage> T deserializeSignableMessage(String message, Class<T> tClass) throws IOException {
        try {
