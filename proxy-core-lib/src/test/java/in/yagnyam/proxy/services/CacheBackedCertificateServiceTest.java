...
public class CacheBackedCertificateServiceTest {
    ...
    public void testGetCertificateBySerialNumber_None() {
        ...
        when(underlyingCertificateService.getCertificateBySerialNumber(anyString())).thenReturn(Optional.empty());
    ...
    public void testGetCertificateBySerialNumber_NotInCache() {
        ...
        CertificateService underlyingCertificateService = mock(CertificateService.class);
        when(underlyingCertificateService.getCertificateBySerialNumber(anyString())).thenReturn(Optional.of(certificate));
    ...
    public void testGetCertificateById_None() {
        CertificateService underlyingCertificateService = mock(CertificateService.class);
        when(underlyingCertificateService.getCertificatesById(anyString())).thenReturn(Collections.emptyList());
    ...
    public void testGetCertificateById_NotInCache() {
        ...
        CertificateService underlyingCertificateService = mock(CertificateService.class);
        when(underlyingCertificateService.getCertificatesById(anyString())).thenReturn(Collections.singletonList(certificate));
