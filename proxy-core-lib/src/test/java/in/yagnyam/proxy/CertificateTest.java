...
public class CertificateTest {
    ...
    public void testExtractOnlyId_Invalid() {
        ...
        assertIllegalArgument("empty string is invalid certificate id", () -> Certificate.extractOnlyId(" "));
        assertIllegalArgument("certificate id with more than 2 tokens is invalid", () -> Certificate.extractOnlyId("abc#dev#123"));
    }
    ...
    public void testExtractSha256Thumbprint_Invalid() {
        assertIllegalArgument("null is invalid certificate id", () -> Certificate.extractSha256Thumbprint(null));
        assertIllegalArgument("empty string is invalid certificate id", () -> Certificate.extractSha256Thumbprint(" "));
        assertIllegalArgument("certificate id with more than 2 tokens is invalid", () -> Certificate.extractSha256Thumbprint("abc#dev#123"));
    }
