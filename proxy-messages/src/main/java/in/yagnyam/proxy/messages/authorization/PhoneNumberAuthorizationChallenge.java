...
public class PhoneNumberAuthorizationChallenge implements SignableMessage, AddressableMessage {

    @NonNull
    public SignedMessage<PhoneNumberAuthorizationRequest> request;
