...
public class PhoneNumberAuthorizationChallengeResponse implements SignableMessage, AddressableMessage {

    @NonNull
    public SignedMessage<PhoneNumberAuthorizationChallenge> challenge;
